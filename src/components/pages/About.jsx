  ...
  return (
    <div className="About-Container w-full h-full">
      <div className="About-hading-p w-full h-full flex flex-col justify-center items-center py-4  px-20 max-sm:px-2 max-sm:py-2 ">
        ...
        <div className="about-Detials-section w-full h-full flex max-sm:flex max-sm:flex-col-reverse my-8  rounded-t-md ">
          <div className="img w-full border border-green-600  border-none">
            <img className=" object-cover max-sm:rounded-b-md rounded-tl-md" src="./images/pexels-divinetechygirl-1181269.jpg" alt="" />
          </div>
